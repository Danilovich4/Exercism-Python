...
def approx_average_is_average(hand):
    ...
    metodo_1 = (hand[0]+hand[-1])/2
    metodo_2 = hand[len(hand)//2]

    promedio = sum(hand)/len(hand)

    if metodo_1 == promedio or metodo_2 == promedio:
        return True
    else:
        return False
...
def average_even_is_average_odd(hand):
    ...
    impares = sum(hand[1::2])/len(hand[1::2])
    pares = sum(hand[::2])/len(hand[::2])
