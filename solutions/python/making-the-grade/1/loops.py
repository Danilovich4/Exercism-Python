...
def student_ranking(student_scores, student_names):
    ...
    for index, nota in enumerate(student_scores):
        texto = f"{index+1}. {student_names[index]}: {nota}"
...
def perfect_score(student_info):
    ...
    for estudiante, nota in student_info:
        if nota == 100:
            estudiante_excelente=[estudiante,nota]
            return estudiante_excelente
